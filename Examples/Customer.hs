...
--		runTxBenchmark customersSHFSTMBench defaultIncParams (10^4) 10 5
		runTxBenchmark customersNonIncEBench ((defaultIncParamsProxy proxyTxAdaptonE) { txAdaptonMemoSize = 10^3 }) (10^3) 10 5
...
--		runTxBenchmark customersTxAdaptonEBench ((defaultIncParamsProxy proxyTxAdaptonE) { txAdaptonMemoSize = 10^4, txAdaptonRepair = True }) (10) 10 5
